  ...
  return (
    <form class="w-full max-w-lg">
        ...
        <div class="w-full px-3">
          ...
          <div class="relative">
            <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-carrera" required>
              ...
              <option>TSU en Tecnologia de la Información</option>
      ...
      <div class="flex flex-wrap -mx-3 mb-6">
        ...
        <textarea class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="Escribe el padecimiento del alumno" required></textarea>
      </div>
      <div class="flex flex-wrap -mx-3 mb-6">
        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-zip">
          Medicamento
